...
exports._handler = function (resolve, reject) { return function (err, stats) {
    if (err) {
        reject(err);
        return;
    }
...
// eslint-disable-next-line import/no-unused-modules
exports._runWebpack = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                flex_plugin_webpack_1.webpack(config_1.default(config_1.ConfigurationType.Webpack, env_1.Environment.Production)).run(exports._handler(resolve, reject));
            })];
    });
}); };
/**
...
var build = function () {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var index, _a, warnings, bundles, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    fs_1.addCWDNodeModule.apply(void 0, __spread(argv));
