...
exports._checkAppConfig = void 0;
var fs_1 = require("fs");
...
var pre_script_check_1 = require("./pre-script-check");
/**
 * Checks appConfig exists
 *
 * @private
 */
exports._checkAppConfig = function () {
    if (!fs_1.existsSync(fs_2.getPaths().app.appConfig)) {
        prints_1.appConfigMissing();
...
var preScriptCheck = function () {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            pre_script_check_1._setPluginDir.apply(void 0, __spread(args));
            exports._checkAppConfig();
            return [2 /*return*/];
        });
    });
};
...
//# sourceMappingURL=pre-start-check.js.map