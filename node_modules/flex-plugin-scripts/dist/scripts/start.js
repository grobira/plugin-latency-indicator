...
exports.start = exports.findPortAvailablePort = exports._startDevServer = exports._updatePluginPort = exports._requirePackages = void 0;
...
exports._requirePackages = function (pluginsPath, pkgPath) {
 ...
 * @param name
 */
exports._updatePluginPort = function (port, name) {
    ...
    fs_1.writeJSONFile(fs_1.getPaths().cli.pluginsJsonPath, config);
};
/**
 ...
 */
/* istanbul ignore next */
exports._startDevServer = function (plugins, options) { return __awaiter(void 0, void 0, void 0, function () {
    var type, port, remoteAll, isJavaScriptServer, isStaticServer, config, devConfig, localPlugins, pluginRequest, hasRemote, _a, onCompile, onRemotePlugins, pluginServerConfig, devCompiler;
    return __generator(this, function (_b) {
        ...
        config = config_1.default(config_1.ConfigurationType.Webpack, env_1.Environment.Development, type);
        devConfig = config_1.default(config_1.ConfigurationType.DevServer, env_1.Environment.Development, type);
 ...
 * @param args
 */
exports.findPortAvailablePort = function () {
    var args = [];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fs_1.addCWDNodeModule.apply(void 0, __spread(args));
                    return [4 /*yield*/, exports.findPortAvailablePort.apply(void 0, __spread(args))];
                case 1:
                    port = _a.sent();
                    ...
                    userInputPlugins = parser_1.parseUserInputPlugins.apply(void 0, __spread([true], args));
