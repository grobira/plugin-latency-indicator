...
exports._hasTypescriptFiles = function () {
 ...
 * @private
 */
exports._validateTypescriptProject = function () {
 ...
 * @private
 */
exports._verifyPackageVersion = function (flexUIPkg, allowSkip, allowReact, name) {
 ...
 */
/* istanbul ignore next */
exports._checkExternalDepsVersions = function (allowSkip, allowReact) {
 ...
 */
/* istanbul ignore next */
exports._readIndexPage = function () {
 ...
 * @private
 */
exports._checkPluginCount = function () {
 ...
 * @private
 */
exports._setPluginDir = function () {
    var args = [];
    ...
    var userInputPlugins = parser_1.parseUserInputPlugins.apply(void 0, __spread([false], args));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fs_2.addCWDNodeModule.apply(void 0, __spread(args));
                    exports._setPluginDir.apply(void 0, __spread(args));
