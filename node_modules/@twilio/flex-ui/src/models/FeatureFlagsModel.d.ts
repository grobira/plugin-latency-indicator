...
export declare enum FeatureFlag {
    ...
    FlexQueuesStatsSLA = "flex-queues-stats-sla",
    FlexQueuesStatsSLAbeta = "flex-queues-stats-sla-beta",
    FlexQueuesStatsPreviewData = "flex-queues-stats-preview-data",
    InsightsPlayer = "insights-player",
    ConversationScreen = "insights-conversation-screen",
    FlexInsights = "flex-insights",
    FlexInsightsForceDisable = "flex-insights-force-disable",
    AdvancedTeamsViewFilters = "advanced-teams-view-filters",
    AdvancedTeamsViewFiltersGA = "advanced-teams-view-filters-ga",
    FileAttachmentsInChat = "file-attachments-in-chat",
    QueueDetail = "flex-queue-detail",
    SingleSession = "flex-single-session",
    DebuggerUI = "flex-debugger-ui",
    DebuggerIntegration = "debugger-integration-v2",
    ChatAutoJoin = "flex-chat-auto-join",
    EmailPOC = "flex-email-POC",
    InsightsNativeDashboards = "insights-native-dashboards",
    InsightsNativeDashboardsBeta = "insights-native-dashboards-beta",
