...
export interface InsightsControllerRenderProps {
    status: InsightsServiceStatus;
    historicalReportingStatus: InsightsServiceStatus;
...
export declare const InsightsController: import("react-redux").ComponentClass<Pick<InsightsControllerProps, "children"> & OwnProps> & {
