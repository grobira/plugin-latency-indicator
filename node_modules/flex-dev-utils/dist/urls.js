 ...
 */
exports.getDefaultPort = function (port) {
    if (port) {
 ...
 */
/* istanbul ignore next */
exports.findPort = function (startPort) {
 ...
 */
exports.getLocalAndNetworkUrls = function (port) {
    var protocol = env_1.isHTTPS() ? 'https' : 'http';
