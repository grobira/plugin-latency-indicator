 ...
 */
exports._getKeychain = function () { return keychain_1.default(exports.SERVICE_NAME); };
/**
...
exports._saveCredential = function (username, password) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(!env_1.default.isCI() && !process.env.SKIP_CREDENTIALS_SAVING)) return [3 /*break*/, 2];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (env_1.default.isCI() && missingCredentials) {
