            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        (_a = result.errors).push.apply(_a, __spread(messages.errors));
                        (_b = stats.compilation.errors).push.apply(_b, __spread(messages.errors));
                        (_c = result.warnings).push.apply(_c, __spread(messages.warnings));
                        (_d = stats.compilation.warnings).push.apply(_d, __spread(messages.warnings));
 ...
 */
exports.compilerRenderer = function (port, localPlugins, showSuccessMsg, hasRemote) {
