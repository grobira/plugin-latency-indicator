...
exports.emitCompileComplete = exports.onIPCServerMessage = exports.startIPCClient = exports.startIPCServer = exports._emitToServer = exports._onClientConnected = exports._onServerMessage = exports._processEmitQueue = exports.isClientConnected = exports.isServerRunning = exports.IPCType = void 0;
...
exports.isServerRunning = function () { return _isServerRunning; };
/* istanbul ignore next */
exports.isClientConnected = function () { return _isClientConnected; };
var clientNode = null;
 ...
 */
/* istanbul ignore next */
exports._processEmitQueue = function () { return __awaiter(void 0, void 0, void 0, function () {
 ...
 * @private
 */
exports._onServerMessage = function (data) {
    if (!data.type) {
        flex_dev_utils_1.logger.error('IPC got an unexpected message: ', data);
        return;
    }
    Object.keys(messageCallbacks).forEach(function (type) {
        var _a;
 ...
 * @private
 */
exports._onClientConnected = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
 ...
 * @private
 */
exports._emitToServer = function (type, payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
 ...
 */
exports.startIPCServer = function () {
 ...
 */
exports.startIPCClient = function () {
    if (exports.isClientConnected()) {
        return;
    }
 ...
 */
/* istanbul ignore next */
exports.onIPCServerMessage = function (type, callback) {
 ...
 * @param payload
 */
exports.emitCompileComplete = function (payload) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
