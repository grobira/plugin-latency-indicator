 ...
 */
exports._getJSScripts = function (flexUIVersion, reactVersion, reactDOMVersion) {
 ...
 */
/* istanbul ignore next */
exports._getImageLoader = function () { return ({
 ...
 * @private
 */
exports._getStyleLoaders = function (isProd) {
    /**
 ...
 * @private
 */
exports._getBasePlugins = function (environment) {
    var plugins = [];
    var appPaths = fs_1.getPaths().app;
    ...
    plugins.push(new webpack_1.DefinePlugin(defined));
    // Support .env file if provided
    if (appPaths.hasEnvFile()) {
        plugins.push(new dotenv_webpack_1.default({
 ...
 * @param environment
 */
exports._getStaticPlugins = function (environment) {
    var plugins = [];
 ...
 * @param environment
 */
exports._getJSPlugins = function (environment) {
    var plugins = [];
 ...
 * @private
 */
exports._getJavaScriptEntries = function () {
    var entry = [];
 ...
 */
/* istanbul ignore next */
exports._getOptimization = function (environment) {
    var isProd = environment === env_1.Environment.Production;
    return {
        splitChunks: false,
        runtimeChunk: false,
 ...
 * @private
 */
exports._getResolve = function (environment) {
    var isProd = environment === env_1.Environment.Production;
 ...
 * @private
 */
exports._getBase = function (environment) {
    var isProd = environment === env_1.Environment.Production;
    var config = {
        ...
        module: {
            ...
            rules: [
                ...
                {
                    oneOf: __spread([exports._getImageLoader(), _getBabelLoader(isProd)], exports._getStyleLoaders(isProd)),
                },
            ],
        },
 ...
 * @private
 */
exports._getStaticConfiguration = function (config, environment) {
    var _a;
    config.plugins = config.plugins ? config.plugins : [];
    (_a = config.plugins).push.apply(_a, __spread(exports._getStaticPlugins(environment)));
    return config;
};
/**
 ...
 * @private
 */
exports._getJavaScriptConfiguration = function (config, environment) {
    var _a, _b;
    var isProd = environment === env_1.Environment.Production;
    ...
    config.plugins = config.plugins ? config.plugins : [];
    // @ts-ignore
    (_a = config.entry).push.apply(_a, __spread(exports._getJavaScriptEntries()));
    config.output = {
    ...
    (_b = config.plugins).push.apply(_b, __spread(exports._getJSPlugins(environment)));
    return config;
};
/**
